...
[Library( Constants.Entity.Drone, Spawnable = true )]
public class DroneEntity : Prop
{
	private readonly Vector3[] turbinePositions =
	{
		new(-35.37f, 35.37f, 10.0f), new(35.37f, 35.37f, 10.0f), new(35.37f, -35.37f, 10.0f),
		new(-35.37f, -35.37f, 10.0f)
	};
	...
	protected void ApplyForces()
	{
		...
		{
			var hoverForce = isGrounded && currentInput.throttle <= 0
				? Vector3.Zero
				: -1 * transform.NormalToWorld( Vector3.Up ) * -800.0f;
	...
	public void OnFrame()
	{
		...
		{
			var transform = Transform.ToWorld( new Transform( turbinePositions[i] * Scale,
				Rotation.From( new Angles( 0, spinAngle, 0 ) ) ) );
