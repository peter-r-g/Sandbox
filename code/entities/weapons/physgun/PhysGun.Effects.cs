...
public partial class PhysGun
{
	...
	private Particles EndNoHit;

	private Vector3 lastBeamPos;
	private ModelEntity lastGrabbedEntity;
	...
	protected virtual void UpdateEffects()
	{
		...
		Beam.SetEntityAttachment( 0, EffectEntity, "muzzle" );
		...
		if ( GrabbedEntity.IsValid() && !GrabbedEntity.IsWorld )
		{
			...
			{
				Beam.SetEntity( 1, GrabbedEntity, GrabbedPos );
			}
			...
			if ( GrabbedEntity is ModelEntity modelEnt )
			{
				...
				glow.RangeMin = 0;
				glow.RangeMax = 1000;
				glow.Color = new Color( 0.1f, 1.0f, 1.0f );
