...
[Library( Constants.Weapon.Flashlight, Spawnable = true )]
public partial class Flashlight : Weapon
{
	...
	public override void Simulate( Client cl )
	{
		...
		var toggle = Input.Pressed( InputButton.Flashlight ) || Input.Pressed( InputButton.Attack1 );
